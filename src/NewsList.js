...
const NewsList = () => {
        ...
        useEffect(() => {
            const getArticles = async () => {
                ...
                const res = await Axios.get('https://newsapi.org/v2/top-headlines?q=Coronavirus&country=IE&category=health&pageSize=4&apiKey=d8e5c413969144569184d0a7433888b8');
